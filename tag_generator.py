...
def description_gen(text,API_key):
...
answer = tag_gen(text,API_key)['choices'][0]['text']
print("Generated tags:", answer)

answer = description_gen(text,API_key)['choices'][0]['text']
print("Generated description:", answer)